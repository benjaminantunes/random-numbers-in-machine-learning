...
## Name of the files to store results
#TIME_FILE="time_results_mt19937arIntegerRandomGeneration.txt"
#POWER_FILE="power_results_mt19937arIntegerRandomGeneration.txt"
...
## Name of the files to store results
#TIME_FILE="time_results_mt19937arIntegerO2RandomGeneration.txt"
#POWER_FILE="power_results_mt19937arIntegerO2RandomGeneration.txt"
...
## Name of the files to store results
#TIME_FILE="time_results_mt19937arIntegerO3RandomGeneration.txt"
#POWER_FILE="power_results_mt19937arIntegerO3RandomGeneration.txt"
...
## Name of the files to store results
#TIME_FILE="time_results_philoxIntegerRandomGeneration.txt"
#POWER_FILE="power_results_philoxIntegerRandomGeneration.txt"

## Clean any existing result files
#> $TIME_FILE
#> $POWER_FILE

#gcc philox.c -o executablePhilox
## Repeat the process 30 times
#for i in {1..30}
#do
#    # Measure the time using built-in time and append to time_results.txt
#    (time ./executablePhilox) 2>> $TIME_FILE
...
# Name of the files to store results
TIME_FILE="time_results_philoxIntegerO2RandomGeneration.txt"
POWER_FILE="power_results_philoxIntegerO2RandomGeneration.txt"

# Clean any existing result files
> $TIME_FILE
> $POWER_FILE

gcc -O2 philox.c -o executablePhiloxO2
# Repeat the process 30 times
for i in {1..30}
do
    # Measure the time using built-in time and append to time_results.txt
    (time ./executablePhiloxO2) 2>> $TIME_FILE
...
# Name of the files to store results
TIME_FILE="time_results_philoxIntegerO3RandomGeneration.txt"
POWER_FILE="power_results_philoxIntegerO3RandomGeneration.txt"

# Clean any existing result files
> $TIME_FILE
> $POWER_FILE

gcc -O3 philox.c -o executablePhiloxO3
# Repeat the process 30 times
for i in {1..30}
do
    # Measure the time using built-in time and append to time_results.txt
    (time ./executablePhiloxO3) 2>> $TIME_FILE
...
## Name of the files to store results
#TIME_FILE="time_results_pcg32IntegerRandomGeneration.txt"
#POWER_FILE="power_results_pcg32IntegerRandomGeneration.txt"
...
# Name of the files to store results
TIME_FILE="time_results_pcg32IntegerO2RandomGeneration.txt"
POWER_FILE="power_results_pcg32IntegerO2RandomGeneration.txt"
...
# Name of the files to store results
TIME_FILE="time_results_pcg32IntegerO3RandomGeneration.txt"
POWER_FILE="power_results_pcg32IntegerO3RandomGeneration.txt"
